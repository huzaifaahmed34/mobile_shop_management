                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="floating-labels m-t-40" id=form action="<?php echo site_url('Customer/AddCustomer')?>">
                                    <div class="row">
                                       <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group m-b-40">
                                        ...
                                        <span class="bar"></span>
                                        <label for="c_addr">Customer Address</label>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group m-b-40">
                                        ...
                                        <span class="bar"></span>
                                        <label for="area_code">Customer Mobile</label>
                                    </div>
                                </div>
                                    </div>
              ...
              <div class="modal-body">
               ...
               <input type="hidden" name="id">
                        ...
                        <div class=" row">
                                    ...
                                    <div class="form-group ">
                                        <!-- <input type="text" class="form-control" id="area_code"> -->
                                            <label for="c_addr">Customer City</label>
             ...
             <option value="">
              ...
              foreach ($qry as $q) {
                ...
                ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group ">
                               <label for="c_addr">Customer Area</label>
...
count=0;
 ...
 showCustomer();
   ...
   showCustomer();
        ...
        //alert('ok');
            $.ajax({
                type: 'ajax',
                url: '<?php echo site_url('Customer/showCustomer')?>',
                async: false,
                dataType: 'json',
        ...
        $('#showCustomer').on('click', '.item-delete', function(){
            ...
            $('#btnDelete').unbind().click(function(){
                $.ajax({
                    ...
                    method: 'post',
                    async: false,
                    url: '<?php echo site_url('Customer/deleteCustomer')?>',
                    data:{id:id},
                    dataType: 'json',
        ...
        $('#showCustomer').on('click', '.item_edit', function(){
            ...
            $.ajax({
                type: 'ajax',
                method: 'get',
                url:'<?php echo site_url('Customer/editCustomer')?>',
                data: {id: id},
                async: false,
                dataType: 'json',
                success: function(data){
 ...
 $('select[name=city_id1]').val(data[i].city_id);
 $("input[name=c_name1]").val(data[i].customer_name);
