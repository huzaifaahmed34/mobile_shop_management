                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            ...
                                            <!-- Message -->
                                            <a href="javascript:void(0)">
                                                <div class="user-img"> <img src="<?php echo base_url(); ?>assets/images/users/3.jpg" alt="user" class="img-circle"> <span class="profile-status away float-right"></span> </div>
                                                <div class="mail-contnet">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                ...
                                <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
                                    ...
                                    <div class="m-l-10">
                                        ...
                                        <p class=" m-b-0"><a href="https://www.wrappixel.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="9aecfbe8eff4dafdf7fbf3f6b4f9f5f7">[email&#160;protected]</a></p>
                                    </div>
                                </div>
