  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Brand Wise Sale</li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box-header with-border">
                  ...
                  <div class="row">
    		    <div class="col-md-3">
    			<h3 class="box-title">Brand Wise Sale</h3>
    			</div>
  ...
  <form method="post" action="<?php echo site_url('Reports/');?>" id="myForm" class="no-print">
        <div class="box-body">
			...
			<div class="from-group">
                   <label>Brand</label>
                    <select id="brand_id" class="form-control" name="brand_id">
                      ...
                      $qry=$this->db->query("SELECT * FROM aims_groups where mh=$group_id and is_deleted=0");
                         $res=$qry->result();
                        foreach($res AS $row)
                        {
         ...
         <table id="example1" class="table  table-striped table-hover js-basic-example dataTable">
            ...
            <tr>
                 <th colspan="2" class="tableTotal">Sub Total</th>
   ...
   $('#btnSearch').click(function(){
       ...
       //validation      
         ...
         var route_id= $('select[name=route_id]');
          ...
          var brand_id = $('select[name=brand_id]');
       ...
       c_id=customer_id.val();
          ...
          customer_id.parent().parent().removeClass('has-error');
           ...
           if(result==1)
           {
            ...
            $.ajax({
                ...
                method:'post',
                data:data,
				url: '<?php echo site_url('Reports/showbrandWiseSale')?>',
				async: false,
				dataType: 'json',
			success: function(data){
					var html = '';
        ...
        $('#btnPrint').click(function(){
            ...
            window.location.href = "<?php echo site_url('Reports/printBrandSale')?>/" + s_date + "/" + e_date  + "/" + c_id;
