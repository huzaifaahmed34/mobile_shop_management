  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Customer Order History</li>
      </ol>
    </section>
        ...
        <div class="box-body">
         ...
         <table id="example" class="table  table-striped table-hover js-basic-example dataTable">
             ...
             <tr>
                 ...
                 <th colspan="1" class="tableTotal text-center"><span id="subTotal"></span></th>
              </tr>
   ...
   $('#btnSearch').click(function(){
          ...
          customer_id.parent().parent().removeClass('has-error');
           ...
           if(result==1)
           {
            ...
            $.ajax({
                ...
                method:'post',
                data:data,
				url: '<?php echo site_url('Reports/showCustomerOrderHistory')?>',
				async: false,
				dataType: 'json',
				success: function(data){
                    ...
                    var subTotal=subTotal + parseFloat(data[i].net_amount);
       ...
       // Data Send For Printer
        $('#btnPrint').click(function(){
            ...
            window.location.href = "<?php echo site_url('Reports/printC_OrderHist')?>/" + s_date + "/" + e_date  + "/" + c_id;
